...
import { mockPaths } from "@yoyo/data";
...
function useRecommendation() {
  ...
  }, [skillLevel, goals, preferredStyles, recommendedPathIds]);
}
...
export default function RecommendationPage() {
  ...
  }, [completeOnboarding, router, path.slug]);

  const handleBrowsePaths = useCallback(() => {
    completeOnboarding();
    router.push("/paths");
