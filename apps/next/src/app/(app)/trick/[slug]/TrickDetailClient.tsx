...
import { getTrickBySlug, getTrickById, mockTricks } from "@yoyo/data";
import { useProgressStore, TrickStatus } from "@yoyo/store";
...
import type { Trick, TrickDifficulty } from "@yoyo/data";
import {
  ArrowLeft,
  Clock,
  Star,
...
export default function TrickDetailClient() {
