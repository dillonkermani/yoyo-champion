...
>(({ className, children, showClose = true, glass = false, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      {showClose && (
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-full p-1.5 text-gray-500 opacity-70 ring-offset-white transition-all duration-150 hover:opacity-100 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-fun-blue focus:ring-offset-2 disabled:pointer-events-none">
          <X className="h-4 w-4" />
